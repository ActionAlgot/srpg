...
namespace FuckingAround {
	...
	public static class Passives {
		public static IEnumerable<PassiveSkill> Default = new PassiveSkill[]{
			...
			new PassiveSkill(new Mod(StatType.PhysicalDamage, ModifyingMethod.Convert|ModifyingMethod.AdditiveMultiply, 0.1/2){ ConversionSource = StatType.Strength})	//10% increase in physical damage per 2 strength
		};
		public static PassiveSkill[] All = new PassiveSkill[]{
			...
			new PassiveSkill(new Mod( StatType.Strength, ModifyingMethod.Convert|ModifyingMethod.Add, 0.1 ){ ConversionSource = StatType.PhysicalDamage}),	//gain 10% of physical damage as bonus fire damage
			new PassiveSkill(new Mod[]{	//Converts 50% of PhysicalDamage to FireDamage
				new Mod( StatType.PhysicalDamage, ModifyingMethod.Multiply, 0.5),
				new Mod( StatType.FireDamage, ModifyingMethod.Convert|ModifyingMethod.Add, 0.5*(1/0.5)){ ConversionSource = StatType.PhysicalDamage }	//multiply value because mod above is applied first
			}),
